...
col0= ""
df= pd.read_csv(uri.raw+ '/vm_csv/area_all_2016_big.txt', nrows=10**9)       
gc.collect()       
...
#   df.to_csv(uri.raw+ r'/vm_csv/area_ALL_BIG_5.txt', index=False, mode='w')
#   df.fillna(0, inplace=True)
...
aa= df.product_type.unique()

df1= df[  df.product_type== 'BLACK TEA' ]



dfbig= pd.pivot_table(df, index= ['統合商品名'], columns= "product_type",  
                          values='total', aggfunc='sum' ).fillna(0).reset_index()
...
for x in dfbig.columns :
    if str(dfbig[x].dtypes) ==  "object" :
      dfbig[x]=  dfbig[x].apply(lambda x :   str_convert_beforeprint(x)  )
  

      
 dfbig.to_csv( 'G:\_project\CCWJ\Temperature_check_2016_sales.csv' )     
...
####    Filter for PowerBI      ############################################################
ll1= [220184848,220190171,220050342,220190171,400069813,220050342,220218513,220165800,220188827,220184848,220190236,220143343,400046681,400050388,220209883,400077670,400022497,220144048,400008538,220233350,220153853,220146695,220209883,220190163,220154337,220134182,220210113,220180451,220204849,220147527,220231800,220200271,220147950,220208798,220148027,220174044,220192840,220174044,220207244,220162496,220199729,220138455,220180532,220199729,400046203,400037917,220203664,220159312,400008544,220320498,220050393,220206892,400025266,220169032,220230327,400015331,220200735,220173749,220197710,220172726,400003655,220099546,220248064,220175781,220271228,220154431,220243445,220242368,220250204,220074268,220074268,220241779,400055189,220250204,220314943,220298193,220172812,220237909,220026131,220269509,400002408,220246967,220305238,220242031,220235256,220239359,220255621,220275649,220241574,220270272,400018413,220327654,220173452,220279946,220276165,220268634,220073792,220284494,220271775,220279849,220270272,220074500,220302204,220237208,220283420,220307389,220292640,220255486,220268200,400029813,400037438,220251502,220243666,220049840,220290362,220292640,400071909,220512370,220253009,220267522,220306110,220229113,220296360,220262407,220252428,220252665,220271198,220289852,220075485,220278117,220290885,400037563,220298363,220251553,220244190,400027339,220256903,400025152,220269207,400025215,220271244,220239308,220255362,220253998,220239448,220235930,220292802,220272097,220235426,220270973,220327638,220246509,220252940,400040496,220115088,220173290,220294988,220100773,220234330,220281789,220315745,220234233,220275185,220234322,220269320,220289593,220298053,220174440,220242090,400044206,220174270,220119407,220173320,220256555,400031928,220247955,220285598,220241612,220248560,220354449,220274502,220285911,220274472,220298096,400018399,220251464,220155519,400044945,220302190,220280812,220243364,220248803,220249257,220291911,400022606,220291881,220252274,400027729,220297030,220155519,220255230,220255230,220446203,220303456,400080635,220274189,220172715,220278893,220305246,400016819,400010901,400010639,220446009,220328820,220270981,220237429,220265810,220445983,400006062,220246800,220304770,220269665,220446262,220235000,220273263,220074446,220241981,220229229,220288147,220073938,220057218,400042213,220264809,220275843,220445819,220289550,220154512,400034811,220256458,220273859,220026921,220252207,220276009,220057218,220304487,220269827,220263144,220249532,220278974,220302093,220282114,220279334,220295763,220257012,400068491,220073733,220264970,220025844,220283900,220301038,400038583,220249249,220257594,220073660,220305084,220327530,220235647,220025542,220287671,220262105,220304630,220301038,
df['バラ_2016年12月']= df['バラ_2016年12月'].astype('float32')

df['バラ_2016年01月']= df['バラ_2016年01月'].astype('int32')
df['バラ_2016年02月']= df['バラ_2016年02月'].astype('int32')
df['バラ_2016年03月']= df['バラ_2016年03月'].astype('int32')
...
df['バラ_2016年10月']= df['バラ_2016年10月'].astype('int32')
df['バラ_2016年11月']= df['バラ_2016年11月'].astype('int32')
df['バラ_2016年12月']= df['バラ_2016年12月'].astype('int32')

df['total']= df['バラ_2016年01月'] +  df['バラ_2016年02月'] +  df['バラ_2016年03月']+ df['バラ_2016年04月'] + df['バラ_2016年05月']+ df['バラ_2016年06月'] + df['バラ_2016年07月'] + df['バラ_2016年08月']  + df['バラ_2016年09月'] + df['バラ_2016年10月'] + df['バラ_2016年11月'] + df['バラ_2016年12月']   
...
def addcol_productcat(x) :
   try :    return  map_product_cate['type_cokeon'][x]
   except : return -1

df['product_type']= df['統合商品名'].apply(addcol_productcat)
...
df['total_bottl']=  df['product_size'] * df['total']

len( df[ df.product_size == 0] )
...
df['local_basho']=   df[ "FS納品場所CD"].apply(addcol_localbasho)
len( df['local_basho'].unique() )

 df.product_size.unique()

####Basho Type 
# map_basho_type=  da.csv_todictmap(uri.map + '/map_fsmaster_areacode_loctype.txt')
# util.save(map_basho_type, uri.map + '/map_fsmaster_areacode_loctype.pkl')
map_basho_type= util.load(uri.map + '/map_fsmaster_areacode_loctype.pkl')

def addcol_inout(x) :
   try :      return  map_basho_type['inout'][x]
   except :   return -1
df['inout']=   df[ "FS納品場所CD"].apply(addcol_inout)


def addcol_bashotype(x) :
   try :      return  map_basho_type['Location_business_condition'][x]
   except :   return -1
df['bashotype']=   df[ "FS納品場所CD"].apply(addcol_bashotype)
len( df['bashotype'].unique() )
...
############################################################################################
##### Summer vs Winter Ratio comparison
df['total_summer']= 0.5 *( df['バラ_2016年07月']*df['product_size']  +  df['バラ_2016年08月']*df['product_size'] )


df['total_winter']= 0.5 *(  df['バラ_2016年02月']*df['product_size'] +  df['バラ_2016年01月']*df['product_size'] )


df['total_bottl'].sum()


### Filter by minimum SKU
df0= df
df= df0[ df0.total > 5 ] 
df= df[ df.total_summer > 0 ] 
df= df[ df.local_basho > 0   ]
...
len( df['FS納品場所CD'].unique() )
df= df[ ['FS納品場所CD', 'product_type','total_summer',  'total_winter', 
         'total_bottl',  'total', 'bashotype', 'inout'  ]  ]


#### Map_Reduce by VM
def perbasho_stat_all(dfi) :
 n_summer=    dfi.total_summer.sum() 
 n_winter=    dfi.total_winter.sum() 
 ratio=       n_summer / (0.001 + n_winter )  #Ratio Sales_Summer / Sales_Winter
 total_bottl= dfi.total_bottl.sum() 
 total_sku=   dfi.total.sum() 
 bashotype=   dfi.bashotype.values[0]
 inout=       dfi.inout.values[0]
  
 d= [ n_summer, n_winter, ratio, total_bottl, total_sku , bashotype, inout  ]
 i= [ "n_summer", "n_winter", "ratio", "total_bottl", "total_sku", "bashotype", "inout"  ]
 return pd.Series(data=d, index=i)


df_basho= df.groupby('FS納品場所CD').apply(perbasho_stat_all)    


df_basho.to_csv(uri.raw+ r'/temperature/vm_rank_summer_winter.csv', mode='w', encoding='utf-8')
...
#### Map_Reduce by VM : product composition   ##############################################
####1st level by product type --> Calculate differences
def perbasho_stat_all2(dfi) :
 n_summer=    dfi.total_summer.sum() 
 n_winter=    dfi.total_winter.sum() 
 n_diff=      abs(n_summer - n_winter )
 # ratio=       n_summer / (0.001 + n_winter )  #Ratio Sales_Summer / Sales_Winter
 total_bottl= dfi.total_bottl.sum() 
 total_sku=   dfi.total.sum() 
 bashotype=   dfi.bashotype.values[0]
 ...
 d= [ n_summer, n_winter, n_diff,  total_bottl, total_sku , bashotype, inout  ]
 i= [ "n_summer", "n_winter", "n_diff", "total_bottl", "total_sku", "bashotype", "inout"  ]
 return pd.Series(data=d, index=i)


df_basho2= df.groupby(['FS納品場所CD', 'product_type']).apply(perbasho_stat_all2)    


df_basho2.to_csv(uri.raw+ r'/temperature/vm_rank_summer_winter_comp.csv', mode='w', encoding='utf-8')


df_basho2['n_diff']=  df_basho2['n_summer'] - df_basho2['n_winter'] 
df_basho2['n_diff2']= df_basho2['n_diff'].apply(abs)
df_basho2.reset_index(inplace=True)


####2nd level by product type --> Aggregate differences
def perbasho_stat_all3(dfi) :
 n_diff=    dfi.n_diff2.sum() 
 n_total_winter=    dfi.n_winter.sum() 
 n_total_summer=    dfi.n_summer.sum()
 ratio=       n_total_summer / (0.001 + n_total_winter )  #Ratio Sales_Summer / Sales_Winter
 
 n_diff_pct=  n_diff / ( 0.001 + n_total_winter )

 total_bottl= dfi.total_bottl.sum() 
 total_sku=   dfi.total_sku.sum() 
 bashotype=   dfi.bashotype.values[0]
 inout=       dfi.inout.values[0]
 
 d= [ n_diff_pct,  ratio,  n_diff, n_total_winter, n_total_summer, total_bottl, total_sku , bashotype, inout     ]
 i= [ "n_diff_pct" ,  "ratio", "n_diff_abs"  ,  "n_total_winter",  "n_total_summer", "total_bottl", "total_sku" , "bashotype", "inout"    ]
 return pd.Series(data=d, index=i)


df_basho3= df_basho2.groupby(['FS納品場所CD']).apply(perbasho_stat_all3)    

df_basho3.sort_values([ 'n_diff_pct' ], ascending=0, inplace=True)
### df_basho4= df_basho3[ df_basho3.n_total_winter > 4800.0 ]


df_basho4= df_basho4[ df_basho4.n_total_summer > 2400.0 ]


df_basho4.to_csv(uri.raw+ r'/temperature/vm_rank_summer_winter_compDiff_filter.csv', mode='w', encoding='utf-8')
...
vm_id= 400031584
df[ df["FS納品場所CD"]== vm_id ].to_csv(uri.raw+ r'/temperature/' + str(vm_id) + '.csv', index=False)
...
df1= pd.read_csv(uri.raw+ r'/vm_csv/area_ALL_BIG.txt', nrows=10**8)   
...
df1.to_csv( uri.map + '/map_vm_jscode_name.txt' )
...
df2['product_type']= df2['統合商品名'].apply(addcol_productcat)
df.product_type.unique()
