...
df2= pd.read_csv(uri.raw+ '/vm_csv/20170120/4334with20a41a34out20_BIG_4.txt', nrows=10**8)         
...
len(df2["FS納品場所CD"].unique())


############################################################################################
#### 1) Add Local basho code ###############################################################
...
#### Total Product SKU
df['total']= df['バラ_2016年01月']  + df['バラ_2016年02月'] + df['バラ_2016年03月'] +  df['バラ_2016年04月'] + df['バラ_2016年05月']+ df['バラ_2016年06月'] + df['バラ_2016年07月'] + df['バラ_2016年08月']  + df['バラ_2016年09月']
...
##  WRITE 
#  df.to_csv(uri.raw+ r'/vm_csv/20170120/4334with20a41a34out20_BIG_3.txt', index=False, mode='w')



############################################################################################
############################################################################################
####Selection for Osaka lcoation
df2=  df[   df['local_basho']== 7312001     ]
#  util.save( df2 , uri.raw + '/temperature/vm_sku_localbasho_7312001.pkl')
df2.fillna(0.0, inplace=True)

df2.sort_values( by=["FS納品場所CD", 'total'], ascending= False, inplace=True)
cols0= ['FS納品場所CD', '統合商品CD', '統合商品名', 'HOTCOLD区分', 'バラ_2015年10月', 'バラ_2015年11月', 'バラ_2015年12月', 'バラ_2016年01月', 'バラ_2016年02月', 'バラ_2016年03月', 'バラ_2016年04月', 'バラ_2016年05月', 'バラ_2016年06月', 'バラ_2016年07月', 'バラ_2016年08月', 'バラ_2016年09月', 'バラ_2016年10月', 'バラ_2016年11月', 'バラ_2016年12月', 'product_type', 'local_basho', 'total', 'inout', 'bashotype' ]

df2[cols0].to_csv(uri.raw +'/temperature/localbasho_7312001.csv', index= False, mode='w')




df_pivot1= pd.pivot_table(df2, index="FS納品場所CD", columns='product_type', 
...
####
ppdt= df[  df.product_type == '-1' ][ '統合商品名']
ppdt= ppdt.drop_duplicates()
ppdt.to_csv(uri.map+ '/missing_vm_product.csv')
...
df_missing= df[  df.product_type == -1 ]['統合商品名'].drop_duplicates() 


df_missing.to_csv(uri.map + '/vm_missing.csv')
