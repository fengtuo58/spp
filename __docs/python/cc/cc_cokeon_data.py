...
uri= dict2({ 'python_cokeon':  r'G:/_project/cokeon/'.replace('/','\\'),
'data':   r'G:/_data/'.replace('/','\\'),
'rawcokeon':   r'G:/_data/raw/cokeon_csv/'.replace('/','\\'),
'rawvm':   r'G:/_data/raw/vm_csv/20170120/'.replace('/','\\'),
'map':   r'G:/_data/map/'.replace('/','\\'),
'raw': 
'out1':  r'G:/_data/out1/'.replace('/','\\')         
} )
# uri.rawcokeon


#Meta Database : reference all tables
ALLDB= util.load( uri.data+'ALL_DB_META.pkl')
ALLDB= dict2(ALLDB, recursive=True)
...
usecols=["user_id", "machine_code", "location_code",  "bottler_code",  'product_name', 
         'temperature', "amount",'purchased_at', 'user_rank_vol', 'js_code']


df= pd.read_csv(uri.rawcokeon+'/201704/purchasings.csv', dtype= dtype0, nrows=10**8) # usecols= usecols,        
...
df.to_csv(uri.rawcokeon+'/201704/purchasings_big.csv', index=False)
############################################################################################
